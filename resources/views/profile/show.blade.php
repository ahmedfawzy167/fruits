                 ...
                 <form action="{{ route('profile.update', ['id' => auth()->user()->id]) }}" method="POST" enctype="multipart/form-data">
                   @csrf
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <div class="pt-2">
                         ...
                         <a href="{{ route('profile.deleteImage') }}" class="btn btn-danger btn-sm" title="Remove my profile image"><i class="bi bi-trash"></i></a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" disabled class="form-control" id="Email" value="{{auth()->user()->email}}">
                      </div>
                    </div>
                     @error('email')
