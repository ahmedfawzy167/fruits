...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('admin/categories')}}">{{__('admin.Categories')}}</a></li>
...
<section class="section">
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{__('admin.Create Categories')}}</h5>
                    ...
                    <form class="row g-3" action="{{route('categories.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                            <label for="inputNanme4" class="form-label">{{__('admin.Category Name')}}</label>
